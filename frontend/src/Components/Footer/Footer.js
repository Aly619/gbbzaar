                ...
                <div className="max-width-1440">
                    <div className="footer-content">
                        ...
                        <div className="column4">
                            ...
                            <p className="c4-para1">javediq999@gmal.com</p>
                            <p className="c4-para2">03466-026689</p>
                            <p className="c4-para3">Haji Gam Skardu Gilgit
                                Baltistan</p>
                    ...
                    <p className="copyright">© Copyright javed iqbal</p>
