...
const PostProduct = ({ user, art, productimg, profilepic, username, userdate }) => {
    ...
    return (
        <>
            {showPopup && <OrderPopup showPopup={showPopup} setShowPopup={setShowPopup}/>}
            <section className="post-details max-width-1440">
                ...
                <div className="left-post">
                    ...
                    <button className='order-post-btn' onClick={handleClick}>Order Now</button>
                    </div>
                </div>
                <div className="right-post">
                   ...
                   <section className="review-section">
                    <h1>Review</h1>
                    <textarea className='add-review' type="text" placeholder ='Write a review....' />
                    ...
                    <button className="my-art-btn">Submit</button>
                   </section>
